# 📸 Self-Hosted API Locket hoanganh

---

## 📖 Giới Thiệu

**Self-Hosted API Locket hoanganh** là một backend API được xây dựng bằng Node.js, phục vụ cho ứng dụng chia sẻ ảnh theo phong cách Locket Widget. Dự án cung cấp các endpoint để xử lý ảnh, quản lý người dùng và phân phối nội dung theo thời gian thực.
...
**Được tạo với ❤️ bởi [Dio](https://github.com/doi2523) | © 2025 [Locket hoanganh](https://locket-dio.com) | Tất cả quyền được bảo lưu**
