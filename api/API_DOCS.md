# 📡 Self-Hosted API Locket hoanganh — API Reference

<p>Tài liệu mô tả toàn bộ các endpoint của Locket hoanganh Self-Hosted API.</p>
...
**[← Về README](./README.md) | © 2025 [Locket hoanganh](https://locket-dio.com)**
