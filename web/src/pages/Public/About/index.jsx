      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-3">
            Giới thiệu về <span className="text-purple-600">Locket hoanganh</span>
          </h1>
          <p className="text-lg text-base-content/80 max-w-2xl mx-auto">
            Locket hoanganh — nền tảng mở rộng dành cho Locket Widget, giúp bạn chia
        ...
        {/* What is Locket hoanganh */}
        <div className="bg-base-300 rounded-3xl shadow-md p-5 mb-8">
          <h2 className="text-2xl font-bold mb-4">Locket hoanganh là gì?</h2>
          <p className="text-base-content/80 leading-relaxed mb-3">
            - Locket hoanganh là nền tảng web được thiết kế để mở rộng khả năng của
            ứng dụng Locket Widget. Với Locket hoanganh, bạn có thể dễ dàng tải lên
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-base-300 rounded-xl shadow-md p-5">
            ...
            <p className="text-base-content/80 leading-relaxed">
              “Locket hoanganh” được tạo ra từ nhu cầu thực tế:
              ...
              <br />
              Từ những câu hỏi đó, Locket hoanganh ra đời như một giải pháp mở rộng,
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-2">
              Mặc dù Locket hoanganh được xây dựng với nền tảng web hiện đại, mình
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              nhưng cũng chính là động lực để Locket hoanganh ngày càng hoàn thiện
              hơn.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-5">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-2">
              Locket hoanganh được phát triển bởi Dio — người yêu công nghệ và đam mê
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Cảm ơn những nhà tài trợ đã đóng góp và đồng hành với "Locket hoanganh"
