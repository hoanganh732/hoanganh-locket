  ...
  return (
    <div className="min-h-screen px-4 flex flex-col items-center py-5">
      <h1 className="text-3xl font-semibold mb-5">
        Hướng Dẫn Sử Dụng Trang Web Locket hoanganh by Dio
      </h1>

      <div className="max-w-3xl text-left mb-12">
        {/* Giới Thiệu */}
        <h2 className="text-2xl font-semibold mt-4">
          1. Giới Thiệu Về Locket hoanganh
        </h2>
        <p className="text-sm leading-relaxed">
          Locket hoanganh là nền tảng WebApp giúp bạn dễ dàng tải lên, lưu trữ và
        ...
        <ul className="list-disc ml-5 text-sm space-y-2">
          ...
          <li>
            <b>Người sáng lập Locket hoanganh là ai?</b> Locket hoanganh được phát triển
          ...
          <li>
            <b>Trang web hỗ trợ các trình duyệt nào?</b> Locket hoanganh hỗ trợ tất
          ...
          <li>
            ...
            Locket hoanganh, hãy liên hệ quản trị viên qua email để được cấp quyền
            hoặc tài liệu hướng dẫn.
          </li>
          <li>
            <b>Trang web có quảng cáo không?</b> Không. Locket hoanganh hoạt động
        ...
        <p className="text-sm">
          Locket hoanganh cam kết bảo mật thông tin tài khoản của bạn. Tất cả các tệp
