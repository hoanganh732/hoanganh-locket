  ...
  return (
    <div className="p-4 mx-auto min-h-screen max-w-3xl text-base-content space-y-4">
      ...
      <h1 className="text-3xl md:text-4xl font-bold">
        Locket hoanganh x Locket Upload
      </h1>

      <p className="text-base text-base-content/80">
        Locket hoanganh hân hạnh hợp tác cùng{" "}
      ...
      <h2 className="text-xl font-semibold mt-6 text-secondary">
        Giới thiệu về Locket hoanganh
      </h2>
      <p>
        Locket hoanganh là một web app được cài đặt bằng cách thêm vào màn hình chính
      ...
      <p>
        ...
        gặp lỗi không thể sử dụng camera trực tiếp trong Locket hoanganh.
      </p>
      <p>
      ...
      <p>
        ...
        trong Locket hoanganh nhìn chung{" "}
      ...
      <p>
        ...
        với Locket hoanganh hoặc Locket Widget của bạn.
      </p>
