...
export const CONFIG = {
  ...
  app: {
    ...
    videoTutorials: {
      ...
      iosAddscreen: {
        title: "Hướng dẫn thêm Locket hoanganh vào màn hình chính trên iPhone!",
        url: "https://www.youtube.com/embed/iElPAnQ7lNY",
      }, // Hướng dẫn thêm trang web vào màn hình chính trên iPhone (Safari)
      androidAddscreen: {
        title: "Hướng dẫn thêm Locket hoanganh vào màn hình chính trên Android!",
