...
const Sidebar = () => {
  ...
  const userMenuSections = [
    {
      title: "Locket hoanganh",
      items: [
        { to: "/home", icon: Home, text: "Trang chủ" },
        { to: "/about", icon: Info, text: "Locket hoanganh" },
  ...
  const guestMenuSections = [
    {
      ...
      items: [
        ...
        { to: "/about", icon: Info, text: "Locket hoanganh" },
        { to: "/about-dio", icon: UserCircle, text: "Về hoanganh" },
      ],
    },
    {
      title: "Tài nguyên",
      ...
      >
        ...
        <div>
          <p className="text-center text-xs pb-2 text-base-content/70">
            ...
            <span className="font-semibold font-lovehouse">hoanganh</span>. All
            rights reserved.
          </p>
        </div>
      </div>
